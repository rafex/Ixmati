...
El perfil
recomendado queda en 10/s con evidencia de una hora; 40/s es diagnóstico. El
SHA `359cf89` repitió un smoke limpio a 10/s (600/600 `200`, outbox 0,
integridad OK) en Debian amd64.
